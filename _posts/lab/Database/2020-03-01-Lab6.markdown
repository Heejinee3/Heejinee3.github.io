...
[Github](https://github.com/Heejinee3/Database/tree/master/Lab6){:target="\_blank"}
...
[B+ Tree](https://velog.io/@chunjakim/B-Tree){:target="\_blank"}

[Extensible Hashing](https://velog.io/@chunjakim/Extensible-Hashing){:target="\_blank"}

[Query Processing](https://velog.io/@chunjakim/Query-Processing){:target="\_blank"}

[Crash Recovery](https://velog.io/@chunjakim/Crash-Recovery){:target="\_blank"}

[Concurrency Control](https://velog.io/@chunjakim/Concurrency-Control){:target="\_blank"}
